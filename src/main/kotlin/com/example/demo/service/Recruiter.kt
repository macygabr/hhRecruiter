...
//
//@Service
//class Recruiter(private val webClient: WebClient.Builder,  private val repository: VacancyRepository, private val hhAuthInfoRepository: HhAuthInfoRepository, private val resumeService: ResumeService) {
...
////
////        hhAuthInfoRepository.save(filter)
//    }
//
...
////        val hhOAuth = HhAuthInfoRepository.findByToken( request.authorizationHeader) ?: throw HttpException(HttpStatus.UNAUTHORIZED, "invalid token")
////
